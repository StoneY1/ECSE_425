This project includes a MIPS assembler written in Java which produces binary instructions from an .asm 
input file.
 The assembler handles multiple error cases and exceptions, and prints relevant error messages 
to command line if errors occur.
